  ...
  return (
    <Flex h="100%" direction="column">
      <VStack alignItems="start" w="100%">
        <SectionTitle
          title="Customize"
          description="Customize the chat widget style based on your website theme."
        />
      </VStack>
      <Formik
              ...
              <HStack w="100%" alignItems="start" overflow="hidden">
                        ...
                        <TabPanels>
                          <TabPanel pt="8">
                              ...
                              {({ field, form }: any) => (
                                <FormControl
                                  ...
                                  isInvalid={
                                    ...
                                    form.touched.chatInputPlaceholderText
                                  }
                                >
                                  <FormLabel
                                    fontSize="sm"
                                    htmlFor="chatInputPlaceholderText"
                                    color="gray.700"
                                    fontWeight="400"
                                  >
                            ...
                            <Box className={styles.nestedFormCont} mt="8">
                              <Text
                                className={styles.nestedFormHeading}
                                fontSize="md"
                                mb="4"
                                pb="2"
                                fontWeight="500"
                                      ...
                                      values.questionExamples.map(
                                        (friend, index) => (
                                          ...
                                          >
                                            ...
                                            <Field
                                              type="text"
                                              name={`questionExamples.${index}.question`}
                                            >
                                              {({ field, form }: any) => (
                                                <FormControl mb="2">
                                                  <FormLabel
                                                    ...
                                                    color="gray.700"
                                                    fontSize="sm"
                                                    htmlFor={`questionExamples.${index}.question`}
                                                  >
                                                    Question
                                                  </FormLabel>
                                                  <Input {...field} />
                                            ...
                                            <Field
                                              type="text"
                                              name={`questionExamples.${index}.label`}
                                            >
                                              {({ field, form }: any) => (
                                                <FormControl mb="2">
                                                  <FormLabel
                                                    ...
                                                    color="gray.700"
                                                    fontSize="sm"
                                                    htmlFor={`questionExamples.${index}.label`}
                                                  >
                                                    Label
                                                  </FormLabel>
                                                  <Input {...field} />
                                ...
                                <FormControl mb="6">
                                  ...
                                  >
                                    <HStack height="38px" spacing="24px">
                                      <Radio {...field} size="md" value="left">
                                        <Text fontSize="sm">left</Text>
                                      </Radio>
                                      <Radio {...field} size="md" value="right">
                              ...
                              {({ field, form }: any) => (
                                ...
                                >
                                  ...
                                  <FormHelperText fontSize="sm">
                                    This base prompt serves as a foundational
                                    instruction set for your chatbot. Feel free
                                    to tailor it to suit your specific needs.
                                    For instance, if you'd like your chatbot to
                                    respond solely in French, include the
                                    directive "Reply only in the French
                                    language".
                                  </FormHelperText>
                                  <FormHelperText fontSize="sm">
                                    It's a good practice to provide some
                                    elementary information about your website in
                                    the base prompt to give your chatbot
                                    context.
                                  </FormHelperText>
                                  <FormErrorMessage>
                                    {form.errors.prompt}
                              ...
                              {({ field, form }: any) => (
                                <FormControl
                                  ...
                                  isInvalid={
                                    ...
                                    form.touched.defaultAnswer
                                  }
                                >
                                  <FormLabel
                                    fontSize="sm"
                                    htmlFor="defaultAnswer"
                                    color="gray.700"
                                    fontWeight="400"
                                  >
                                    Default Answer
                                  ...
                                  />
                                  <FormHelperText fontSize="sm">
                                    This field allows you to set a default
                                    response for the chatbot when it can't find
                                    an appropriate answer. You can personalize
                                    it with your own text or even translate it
                                    into another language.
                                  </FormHelperText>
                                  <FormHelperText fontSize="sm">
                                    For example, you could write 'Sorry, I don't
                                    have the answer to that. Please email
                                    hi@example.com for help.'
                                  </FormHelperText>
                                ...
                                {({ field, form }: any) => (
                                  <FormControl
                                    ...
                                    isInvalid={
                                      ...
                                      form.touched.collectEmailText
                                    }
                                  >
                                    <FormLabel
                                      fontSize="sm"
                                      htmlFor="collectEmailText"
                                      color="gray.700"
                                      fontWeight="400"
                                    >
                                      Collect email Text
                            ...
                            <Field type="text" name="model">
                              {({ field, form }: any) => (
                                ...
                                >
                                  ...
                                  <Select
                                    {...field}
                                    isDisabled={subscriptionName === 'FREE'}
                                    cursor="pointer"
                                  >
                                  ...
                                  <FormHelperText fontSize="sm">
                                    Token consumption will be 30 times higher
                                    for GPT-4 compared to GPT-3.5.
                                  </FormHelperText>
                                </FormControl>
                              )}
                            </Field>
                            ...
                            <Field type="text" name="adminEmail">
                              {({ field, form }: any) => (
                                ...
                                >
                                  ...
                                  />
                                  <FormHelperText fontSize="sm">
                                    By default, offline messages are forwarded
                                    to account owner's email address.
                                  </FormHelperText>
                                  <FormErrorMessage>
                                    {form.errors.adminEmail}
                                  </FormErrorMessage>
                              ...
                              {({ field, form }: any) => (
                                <FormControl
                                  ...
                                  isInvalid={
                                    ...
                                    form.touched.assistantTabHeader
                                  }
                                >
                                  <FormLabel
                                    fontSize="sm"
                                    htmlFor="assistantTabHeader"
                                    color="gray.700"
                                    fontWeight="400"
                                  >
                              ...
                              {({ field, form }: any) => (
                                <FormControl
                                  ...
                                  isInvalid={
                                    ...
                                    form.touched.offlineMsgTabHeader
                                  }
                                >
                                  <FormLabel
                                    fontSize="sm"
                                    htmlFor="offlineMsgTabHeader"
                                    color="gray.700"
                                    fontWeight="400"
                                  >
                              ...
                              {({ field, form }: any) => (
                                <FormControl
                                  ...
                                  isInvalid={
                                    ...
                                    form.touched.offlineMsgHeading
                                  }
                                >
                                  <FormLabel
                                    fontSize="sm"
                                    htmlFor="offlineMsgHeading"
                                    color="gray.700"
                                    fontWeight="400"
                                  >
                                    Heading
                              ...
                              {({ field, form }: any) => (
                                <FormControl
                                  ...
                                  isInvalid={
                                    ...
                                    form.touched.offlineMsgDescription
                                  }
                                >
                                  <FormLabel
                                    fontSize="sm"
                                    htmlFor="offlineMsgDescription"
                                    color="gray.700"
                                    fontWeight="400"
                                  >
                                    Description
                            ...
                            <Accordion allowToggle allowMultiple>
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.nameFieldPlaceholder
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="nameFieldPlaceholder"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.emailFieldLabel
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="emailFieldLabel"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                                          Email Field Label
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.emailFieldPlaceholder
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="emailFieldPlaceholder"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.msgFieldLabel
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="msgFieldLabel"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                                          Message Field Label
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.msgFieldPlaceholder
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="msgFieldPlaceholder"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.requiredFieldMsg
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="requiredFieldMsg"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.invalidEmailMsg
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="invalidEmailMsg"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                              ...
                              >
                                ...
                                <AccordionPanel>
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.formSubmitBtnLabel
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="formSubmitBtnLabel"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                                          Submit Button Label
                                  ...
                                  <Field
                                    type="text"
                                    name="formSubmitBtnSubmittingText"
                                  >
                                    {({ field, form }: any) => (
                                      <FormControl
                                        mb="6"
                                      ...
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="formSubmitBtnSubmittingText"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                                          Submitting Text
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.formSubmitSuccessMsg
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="formSubmitSuccessMsg"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.formSubmitErrorMsg
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="formSubmitErrorMsg"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.formSendAgainBtnLabel
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="formSendAgainBtnLabel"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                                    ...
                                    {({ field, form }: any) => (
                                      <FormControl
                                        ...
                                        isInvalid={
                                          ...
                                          form.touched.formTryAgainBtnLabel
                                        }
                                      >
                                        <FormLabel
                                          fontSize="sm"
                                          htmlFor="formTryAgainBtnLabel"
                                          color="gray.700"
                                          fontWeight="400"
                                        >
                            ...
                            <Field type="text" name="customCSS">
                              {({ field, form }: any) => (
                                <FormControl
                                  mb="6"
                                  isInvalid={
                                    form.errors.customCSS &&
                                    form.touched.customCSS
                                  }
                                >
                                  <FormLabel
                                    fontSize="sm"
                                  ...
                                  />
                                  <FormHelperText fontSize="sm">
                                    Please use this feature with caution and
                                    only if you require specific styling
                                    adjustments that can't be achieved through
                                    our standard customization options. You are
                                    responsible for maintaining backward
                                    compatibility with any updates we make.{' '}
                                  </FormHelperText>
                                  <FormHelperText fontSize="sm">
                                    Note: Changes will not appear in the app's
                                    customization section, only in the actual
                                    widget.{' '}
                                  </FormHelperText>
                                </FormControl>
                              )}
                ...
                >
                  <div
                    ...
                    id="chat-wrap"
                    style={{ marginTop: '0', minHeight: '600px' }}
                  >
                    <div
                      ...
                      >
                        ...
                        {selectedTab === 1 && (
                          <div className="offline-message-header">
                            <h2>{values.offlineMsgHeading}</h2>
                      ...
                      >
                        {selectedTab === 0 && (
                          ...
                          >
                            ...
                            <div
                              className={styles.chatSampleMessages}
                              id="chat-sample-messages"
                            >
                              {values.questionExamples.map(
                                (item: any, index: number) => (
                                  <button
                                    ...
                                    className={styles.chatSampleMessage}
                                    data-message={item.question}
                                    key={index}
                                  >
                                    {item.label}
                                  </button>
                            ...
                            <Box id="chat-form">
                              <div className="chat-input-wrap">
                                <textarea
                                  ...
                                  rows={1}
                                  className="chat-input textarea js-auto-size"
                                  id="chat-input"
                                  placeholder={values.chatInputPlaceholderText}
                                ></textarea>
                                <button className="chat-submit-btn">
                                  ...
                                  >
                                    <path
                                      ...
                                      style={{ fill: values.backgroundColor }}
                                    ></path>
                                  </svg>
                                </button>
                              </div>
                          ...
                          >
                            <div className={styles.formGroup}>
                              <label className={styles.formLabel}>
                                {values.nameFieldLabel}{' '}
                                <span className={styles.formRequired}>*</span>
                              </label>
                              <input
                                type="text"
                                className={styles.formControl}
                                id="offline-message-name"
                                placeholder={values.nameFieldPlaceholder}
                              ></input>
                            ...
                            <div className={styles.formGroup}>
                              ...
                              <input
                                type="text"
                                className={styles.formControl}
                                id="offline-message-email"
                                placeholder={values.emailFieldPlaceholder}
                              ></input>
                              {/* <div className={styles.invalidFeedback} id="invalid-feedback-email-invalid">{values.invalidEmailMsg}</div> */}
                            </div>
                            <div className={styles.formGroup}>
                              <label className={styles.formLabel}>
                                {values.msgFieldLabel}{' '}
                                <span className={styles.formRequired}>*</span>
                              </label>
                              <textarea
                                className={styles.formControl}
                                rows={4}
                                id="offline-message-message"
                                placeholder={values.msgFieldPlaceholder}
                              ></textarea>
                            </div>
                            <button
                              className={styles.formSubmit}
                              id="offline-message-submit"
                              type="button"
                              style={{
                                backgroundColor: values.backgroundColor,
                                color: values.fontColor,
                    ...
                    <ChatBotLauncher
                      ...
                      launcherIcon={values.launcherIcon.id}
                    />
                  </div>
                </Flex>
              </HStack>
