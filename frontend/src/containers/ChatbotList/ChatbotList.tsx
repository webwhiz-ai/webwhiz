  ...
  const onMenuItemClick = React.useCallback(
    async (type, chatbot) => {
      if (type === 'edit') {
        ...
        setChatBotList(
          chatbotsList?.filter((_chatbot) => _chatbot._id !== chatbot._id),
        );
        toast({
        ...
        >
          ...
          <Box textAlign="center">
            ...
            <HStack justify="center">
              ...
              <ChakraLink
                href={
                  'https://webwhiz.lemonsqueezy.com/checkout/buy/60da93fa-87b8-4fcd-9176-48da47405541?checkout[email]=' +
                  user.email
                }
                isExternal
              >
                <Button variant="outline" colorScheme="blue" size="md">
                  Buy 50K tokens for $5
                </Button>
              </ChakraLink>
            </HStack>
          </Box>
      ...
      return (
        <MediaListItem
          ...
          isPrimaryButtonLoading={
            createChatBotLoading[chatbot._id] || chatbot.status === 'CRAWLING'
          }
      ...
      >
        <VStack w="100%" spacing="10">
          <Flex shrink={0} w="100%" justifyContent="space-between">
            ...
            {user && PAID_ONLY && user?.subscriptionData?.name === 'FREE' ? (
              <Tooltip label={'Upgrade to a paid plan to create chatbots'}>
                <Button colorScheme="blue" size="md">
                  Create new chatbot
                </Button>
              </Tooltip>
