...
export const CreateChatBots = () => {
  ...
  const [primaryButtonLabel, setPrimaryButtonLabel] =
    React.useState('Verify pages');
  const [isSubmitting, setIsSubmitting] = React.useState<boolean>(false);
  const [isSecondaryBtnSubmitting, setIsSecondaryBtnSubmitting] =
  ...
  const handlePrimaryButtonClick = React.useCallback(
    async (payLoad: ProductSetupData) => {
      ...
      try {
        ...
        let interval = setInterval(async () => {
          ...
          if (
            ...
            setProductSetupLoadingText(
              'Training ChatGPT with your data... This may take some time based on the amount of the data...',
            );
  ...
  const handleSecondaryButtonClick = React.useCallback(
    async (payLoad: ProductSetupData, hasWebsiteDataChanged: boolean) => {
      console.log('payload', payLoad);
      setIsSubmitting(true);
