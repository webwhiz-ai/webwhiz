...
const demoChatBotsData = [
  {
    ...
    customizationValues: {
      ...
      description:
        'I am trained on <a style="text-decoration:underline; font-weight:bold" href="https://stripe.com/docs" target="_blank">Stripe docs</a>. Ask me anything you want to know about Stripe',
      fontColor: '#FFF',
      borderRadius: '12px',
      placement: 'right',
  ...
  },
  {
    ...
    name: 'Stripe docs',
    description:
      'Trained on ProductHunt launch docs. - https://www.producthunt.com/launch',
    imageUrl: 'https://www.paritydeals.com/images/integrations/stripe-logo.svg',
    customizationValues: {
      backgroundColor: '#da5225',
      heading: 'I am your ProductHunt launch assistant',
      description:
        'I am trained on <a style="text-decoration:underline; font-weight:bold" href="https://www.producthunt.com/launch" target="_blank">ProductHunt launch docs</a>. Ask me anything you want to know about launching on ProductHunt.',
      fontColor: '#FFF',
      borderRadius: '12px',
      placement: 'right',
      welcomeMessage: 'Hello! How can I assist you today?',
  ...
  },
  {
    ...
    customizationValues: {
      ...
      description:
        'I am trained on <a style="text-decoration:underline; font-weight:bold" href="https://www.paritydeals.com/" target="_blank">ParityDeals.com</a>. Ask me anything',
      fontColor: '#FFF',
      borderRadius: '12px',
      placement: 'right',
      welcomeMessage: 'Hello! How can I assist you today?',
    ...
    return (
      ...
      >
        <Heading
          ...
          textAlign="center"
        >
          Train Chat GPT on your website's data and create a chatbot within
          minutes
        </Heading>
      </VStack>
    );
